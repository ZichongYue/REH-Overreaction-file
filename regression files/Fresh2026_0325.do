...
log using Fresh2026_0325, replace

use dta/panel_data, clear
xtset panelid Year

gen ps = freshCPI_lag /* ps: public signal */
gen Depvar = FFE /* Depvar: dependent variable */
/*
================================================================================
REGRESSION ANALYSIS 
================================================================================
...
outreg2 using Fresh.xls, replace dec(3) ///
ctitle(FFE) keep (ps)
...
outreg2 using Fresh.xls, append dec(3) ///
ctitle(FFE) keep (ps DHiI)
*
...
outreg2 using Fresh.xls, append dec(3) ///
ctitle(FFE) keep (ps DHiI 1.zDC_lag c.ps#1.zDC_lag)
...
outreg2 using Fresh.xls, append dec(3) ///
ctitle(FFE) keep (ps DHiI 1.FLgroup1_lag c.ps#1.FLgroup1_lag)
...
outreg2 using Fresh.xls, append dec(3) ///
ctitle(FFE) keep (ps DHiI 1.SCgroup1_lag c.ps#1.SCgroup1_lag)
...
outreg2 using Fresh.xls, append dec(3) ///
ctitle(FFE) keep (ps DHiI price_z_lag c.ps#c.price_z_lag)
