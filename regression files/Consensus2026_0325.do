...
log using Consensus2026_0325, replace

use dta/panel_data, clear
xtset panelid Year

gen ps = L.mean_EI /* ps: public signal */
...
outreg2 using consensus.xls, replace dec(3) ///
ctitle(CFE) keep (ps)
...
outreg2 using consensus.xls, append dec(3) ///
