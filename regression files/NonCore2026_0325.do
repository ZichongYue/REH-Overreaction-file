...
log using NonCore2026_0325, replace

use dta/panel_data, clear
xtset panelid Year

gen ps = CPI_lag /* ps: public signal */
gen Depvar = FE /* Depvar: dependent variable */
/*
================================================================================
REGRESSION ANALYSIS 
================================================================================
...
/*
--------------------------------------------------------------------------------
Forecast error of CPI inflation  
--------------------------------------------------------------------------------
*/
*
...
outreg2 using CPIInflation.xls, replace dec(3) ///
ctitle(FE) keep (ps)
...
outreg2 using CPIInflation.xls, append dec(3) ///
